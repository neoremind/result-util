...
import net.neoremind.resultutil.resourcebundle.xml.XMLResourceBundleFactory;
...
public abstract class ResourceBundleFactory implements ResourceBundleConstant {
    ...
    private static final class Helper {
        ...
        private static AbstractResourceBundle getBundleImpl(String baseName, Locale locale,
            ...
            try {
                ...
                List<Object> bundlesFound = new ArrayList<Object>();
     ...
     */
    private static final class Cache extends HashMap<CacheKey, Object> {
        /**
